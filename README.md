...
### 预编译版本
访问 [GitHub Releases](https://github.com/your-username/Media-File-Provenance/releases) 获取最新版本的可执行文件。
...
### 源码运行
```bash
git clone https://github.com/your-username/Media-File-Provenance.git
